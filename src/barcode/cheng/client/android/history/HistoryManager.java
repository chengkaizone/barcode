...
import barcode.cheng.client.android.demo.CaptureActivity;
import barcode.cheng.client.android.demo.HistoryClickListener;
import barcode.cheng.client.android.demo.PreferencesActivity;
...
public final class HistoryManager {
	...
	public List<Result> getHistoryItems() {
	...
	public void addHistoryItem(Result result) {
		...
		boolean rememberDuplicates = prefs.getBoolean(
				PreferencesActivity.KEY_REMEMBER_DUPLICATES, false);
