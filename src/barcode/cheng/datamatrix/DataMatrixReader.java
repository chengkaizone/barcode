package barcode.cheng.datamatrix;
...
import barcode.cheng.datamatrix.decoder.DataDecoder;
import barcode.cheng.datamatrix.detector.DataDetector;
...
public final class DataMatrixReader implements Reader {
	...
	public Result decode(BinaryBitmap image, Hashtable hints)
		...
		if (hints != null && hints.containsKey(DecodeHintType.PURE_BARCODE)) {
			...
			DetectorResult detectorResult = new DataDetector(image.getBlackMatrix())
					.detect();
